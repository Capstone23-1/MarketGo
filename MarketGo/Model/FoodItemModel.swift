...
extension Store{
    static let foodItems: [FoodItem] = foodItems
    
    static let stores: [Store] = [
        Store(store_name: "Store A", address1: "123 Main St", store_ratings: 4.5, store_phone_num: "555-555-1234", card_avail: true, local_avail: false, reviewCnt: 10, products: [foodItems[0],foodItems[1],foodItems[2]], store_num: 1, store_image: "basket"),
