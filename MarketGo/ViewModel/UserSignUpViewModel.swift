        ...
        Auth.auth().createUser(withEmail: email, password: password) { [weak self] authResult, error in
            ...
            DispatchQueue.main.async {
                ...
                if let error = error {
                    ...
                    let newMemberInfo = MemberPostInfo(memberID: 0, memberToken: strongSelf.uid!, memberName: self!.nickName, interestMarket: 0, cartID: 0, storeID: nil, recentLatitude: 0.0, recentLongitude: 0.0)
